...
IND = {
    "hvac":        dict(label="HVAC", half=75, deal=6500, hook="seasonal tune-up urgency",
                        ...
                        note="Quotes die fastest in shoulder seasons. Revive them right before the first heat wave or cold snap, when urgency comes back on its own.",
    ...
    "plumb":       dict(label="Plumbing", half=60, deal=1800, hook="preventive-issue check-in",
                        ...
                        note="Most dead plumbing leads were urgent once. Open with 'is that still an issue?' instead of a pitch. Speed beats polish in this trade.",
    ...
    "roof":        dict(label="Roofing", half=120, deal=12000, hook="storm-season inspection",
                        ...
                        note="Insurance-claim angles revive stalled roofing quotes better than discounts. Mention the exact date of the original inspection.",
    ...
    "real estate": dict(label="Real Estate", half=240, deal=9000, hook="market-shift update",
                        ...
                        note="Buyer leads from 12 to 18 months ago turn gold when rates or inventory shift. Open with the market change, never with 'just checking in'.",
    ...
    "solar":       dict(label="Solar", half=180, deal=21000, hook="incentive-deadline angle",
                        ...
                        note="Price objections dominate dead solar leads. Revive with updated incentive and financing math, not enthusiasm. Show the new monthly number.",
    ...
    "dent":        dict(label="Dental", half=150, deal=1200, hook="overdue-recall reactivation",
                        ...
                        note="Patient recall is the highest-ROI list in dentistry. 'You're overdue' outperforms any promotion. Keep texts under 160 characters.",
    ...
    "law":         dict(label="Law Firm", half=90, deal=5000, hook="case-status check-in",
                        ...
                        note="Consult no-shows usually mean fear, not disinterest. A low-pressure 'your situation may have changed' note works. Mind bar advertising rules.",
    ...
    "med spa":     dict(label="Med Spa", half=90, deal=900, hook="new-treatment invite",
                        ...
                        note="Consultation ghosts reply to a specific treatment invite with a date attached, not a generic 'we miss you'. New treatments drive replies.",
    ...
    "kitchen":     dict(label="Kitchen Remodeling", half=180, deal=28000, hook="design-consult revival",
                        ...
                        note="Big remodels stall on money timing. Check in quarterly with one new project photo and a financing option. Never pressure.",
    ...
    "insur":       dict(label="Insurance", half=120, deal=2400, hook="policy-review window",
                        ...
                        window="weekdays 9–11am",
                        note="Quote shoppers from six months ago can be re-shopped at renewal. Time the revival to their likely renewal month. Be strict about TCPA on SMS.",
    ...
    "mortgage":    dict(label="Mortgage", half=150, deal=8000, hook="rate-change alert",
                        ...
                        note="Every rate drop resurrects your whole dead pipeline. Expired pre-approvals are the first call list. Never promise specific rates in writing.",
    ...
    "landscap":    dict(label="Landscaping", half=90, deal=4200, hook="seasonal project window",
                        ...
                        window="weekdays 7–9am",
                        note="Quotes die over winter and revive in spring. A February 'lock your spring slot' message beats the April competition.",
    ...
    "pest":        dict(label="Pest Control", half=60, deal=600, hook="seasonal treatment reminder",
                        ...
                        window="weekdays 8–10am",
                        note="One-time customers are your recurring-plan goldmine. Revive with the seasonal threat ('ant season starts now'), not a discount.",
    ...
    "fitness":     dict(label="Fitness Studio", half=60, deal=600, hook="comeback-offer nudge",
                        ...
                        note="Lapsed members respond to identity ('athletes like you'). Trial ghosts respond to removed friction ('your first class is still waiting').",
    ...
    "chiro":       dict(label="Chiropractor", half=90, deal=800, hook="care-plan check-in",
                        ...
                        window="weekdays 11am–1pm",
                        note="Patients who stopped mid-care-plan are the list. 'Your last visit left the plan unfinished' works. Wellness content does not.",
    ...
    "clean":       dict(label="Cleaning Services", half=60, deal=350, hook="schedule-reset offer",
                        ...
                        window="weekdays 9–11am",
                        note="One-time cleans convert to recurring around the third touch. Build the sequence for the recurring plan, not another one-off.",
    ...
    "ecommerce":   dict(label="E-commerce", half=45, deal=120, hook="back-in-stock / winback offer",
                        ...
                        note="A past buyer is far cheaper to reactivate than a new one is to acquire. Segment by last-order recency and category.",
...
DEFAULT_IND = dict(label="Local Services", half=90, deal=3000, hook="value-led check-in",
                   ...
                   note="Open with the specific reason they contacted you in the first place. Generic 'checking in' messages are why revival campaigns fail.",
